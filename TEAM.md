...
- `channels/{role}-questions.md` - Planner ↔ that role: work order at top (do it top-down), questions with inline answers below.
...
9. **Never touch:** {SACRED PATHS - e.g. secrets files, prod configs, .sync state, personal data dirs}.
...
6. Check your session memory before re-deriving anything established.
